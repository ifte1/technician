  ...
  <?php
      include 'Back_End/UpdateUserInfo.php';
...
<body>
  ...
  <form id="user" class="input-group"action="Back_End/UpdateUserInfoInsert.php?id=<?php echo $id ; ?>" onsubmit="return validation();" method="POST">
